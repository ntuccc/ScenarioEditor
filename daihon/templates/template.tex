...
{&- with s = processor(scenario.dialogue[handler]['speaker']), clist = scenario.dialogue[handler]['speaker_list']|select('in', scenario.character), abb_list = scenario.character|getitem_by_list(clist)|map(attribute = 'abbreviated') &}
